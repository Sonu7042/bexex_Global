...
const contents = [
  {
    ...
    description:
      "We provide EHS solutions that go beyond compliance to build a resilient safety culture. We partner with you to protect your people and assets, transforming your EHS performance into a competitive advantage. Our approach integrates deep technical expertise with practical, on-the-ground implementation to manage risk effectively across all operations, from initial design to decommissioning.",
    items: [
      "FIRE SAFETY",
      "ELECTRICAL SAFETY",
      "CONSTRUCTION SAFETY",
  ...
  },
  {
    ...
    description:
      "Through our eGrowth India brand, we provide cutting-edge digital solutions to automate, track, and manage your EHS and  Quality processes. We build custom software and implement powerful platforms that provide real-time insights, improve  efficiency, and empower your team with the data they need to make better decisions.",
    items: [
      "CUSTOM EHS   SOFTWARE",
