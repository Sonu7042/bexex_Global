    ...
    <>
      <section className="blog-grid-section">
        <div className="blog-grid-container">
          {blogPosts.slice(0, visibleCount).map(
            (
              post,
              idx // ✅ only change
            ) => (
          ...
          <div className="see-more-wrapper">
            ...
            >
              ...
              <span className="arrow-box">
                <span className="arrow2 arrow-default"><IoMdArrowDown /></span>
                <span className="arrow2 arrow-hover"><IoMdArrowDown /></span>
                <span className="arrow-overlay"></span>
              </span>
            </button>
          </div>
        )}
